                    ...
                    {[...Array(6)].map((_, idx) => (
                      ...
                      >
                        ...
                        <InputField
                          ...
                          placeholder={`Titulo del capítulo ${idx + 1}`}
                        />
                        <InputField
                          register={register}
                          label={`step_${idx + 1}_description`}
                          placeholder={`Descripción del capítulo ${idx + 1}`}
                        />
                        <InputField
                          register={register}
                          label={`step_${idx + 1}_url`}
                          placeholder={`Dirección URL hacia el contenido del capítulo ${
                            idx + 1
                          }`}
                        />
                        <SelectField
                          ...
                          placeholder={`Tipo de archivo del capítulo ${
                            idx + 1
                          }`}
                          values={[
                            {
